...
if gs -sDEVICE=jpeg -dTextAlphaBits=4 -r75 -o "$ImageOutput"sd/tmp%03d.jpg $InputDirectory > /dev/null;then
...
if gs -sDEVICE=jpeg -dTextAlphaBits=4 -r150 -o "$ImageOutput"hd/tmp%03d.jpg $InputDirectory > /dev/null;then
